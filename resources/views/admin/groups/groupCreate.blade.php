            ...
            <form action="{{route('admin.groups.store')}}" method="POST">
                <div class="row mb-4">
                    ...
                    <div class="col-md-9 col-lg-10">
                        <input type="text" class="form-control col-md-8 col-lg-6" id="groupName" name="name" required>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-9 col-lg-10">
                        <div class="col-md-8 col-lg-6 p-0" id="translationsContainer">
                            <input id="searchField" type="text" class="form-control mb-4" onkeyup="getTranslationKeys(this.value)">
                        </div>
                    </div>
                </div>
